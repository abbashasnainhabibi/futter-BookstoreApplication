                        ...
                        if (!_agreeToTerms) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              ...
                              backgroundColor: Color.fromARGB(255, 222, 4,
                                  2), // Set the background color of the SnackBar
                            ),
                          );
                        } else {
                    ...
                    style: TextButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                        side: const BorderSide(
                          color:
                              Colors.grey, // Border color same as text fields
                          width: 1, // Border width
                        ),
                        borderRadius: BorderRadius.circular(
                            4), // Same border radius as the input fields
                      ),
                    ),
                    child: const Center(
                      child: Text(
