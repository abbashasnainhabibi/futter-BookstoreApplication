...
import 'package:bookstore/view_more_items_from_category/non-fiction.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';

class Mycategorynonfiction extends StatelessWidget {
  final User? user;
  const Mycategorynonfiction({super.key, required this.user});
  ...
  Widget _buildRetailNetworkSearch() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(' Non-Fiction', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          GestureDetector(
            onTap: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => Myviewmore_nonfiction(user: user),
                ),
              );
            },
            child: const Text(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Image.asset(
                'assets/images/non fiction books/Atomic Habits.jpg',
                height: 50,
              ), // Book Image
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'A practical guide to building good habits and breaking bad ones, focusing on the power of small changes that lead to significant results over time.',
